...
% Courier 10 Pitch
\def\courierFont{Courier10 WGL4 BT}
...
\author{
	Lev Walkin <\href{mailto:vlm@lionet.info?Subject=asn1c}{vlm@lionet.info}> 
	\and 
	Rémi COHEN SCALI  <\href{mailto:remi.cohen-scali@ampere.cars?Subject=asn1c}{remi.cohen-scali@ampere.cars}>
}
...
{\ttfamily -Gmake} & {\small Generate support files for building with make (default)}\\
{\ttfamily -Gcmake} & {\small Generate support files for building with cmake}\\
{\ttfamily -Glxmake} & {\small Generate support files for building with Linux makefiles (for building code as a Linux kernel part)}\\
